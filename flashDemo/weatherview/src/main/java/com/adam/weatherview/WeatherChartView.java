...
/**
 * Created by adamDeng on 2019/10/30
...
public class WeatherChartView extends View {
    ...
    public WeatherChartView(Context context, AttributeSet attrs){
        ...
        mTextSize=typedArray.getDimensionPixelSize(R.styleable.WeatherChartView_textSize,(int)(14*densityText));
        mColorDay=typedArray.getColor(R.styleable.WeatherChartView_dayColor,getResources().getColor(R.color.colorAccent));
        mColorNight=typedArray.getColor(R.styleable.WeatherChartView_nightColor,getResources().getColor(R.color.colorPrimary));
        mTextColor=typedArray.getColor(R.styleable.WeatherChartView_textColor, Color.WHITE);
        typedArray.recycle();
